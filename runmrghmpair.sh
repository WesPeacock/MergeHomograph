...
mv mrghmpair.ini  mrghmpair.bak
perl -pE "s/FwdataIn.*/FwdataIn=$barefname-before.fwdata/; s/FwdataOut.*/FwdataOut=$fwdatafile/"  mrghmpair.bak > mrghmpair.ini
./mrghmpair.pl
...
mv  mrghmpair.bak mrghmpair.ini
echo
